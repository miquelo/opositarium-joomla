        ...
        if (empty($message)) {
            ...
            if ($wallOptions) {
                ...
                if ($wallParams->get('object_url')) {
                    if ($wallParams->get('object_title')) $wallLink = '<a href="'.JUri::root().trim(JRoute::_($wallParams->get('object_url')), '/').'">'.$wallParams->get('object_title').'</a>';
                    else $wallLink = '<a href="'.JUri::root().trim(JRoute::_($wallParams->get('object_url')), '/').'">'.$wallOptions->object_name.'</a>';
                } else {
