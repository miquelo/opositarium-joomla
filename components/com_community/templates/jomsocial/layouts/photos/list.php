    ...
    joms.util.loadLib( 'dragsort', function() {
        $('.joms-list--photos').dragsort({
            ...
            dragEnd: function() {
                ...
                // Disable click briefly to fix Firefox issue which automatically click links after
                // drag end.
                $links.on( 'click.dragsort', function( e ) { e.preventDefault() });
                setTimeout(function() {
                    $links.off( 'click.dragsort' );
                }, 500 );
